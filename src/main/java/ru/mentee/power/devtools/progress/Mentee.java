...
/**
 * Record для представления mentee с информацией о прогрессе обучения. Автоматически создаёт
 * конструктор и геттеры: name(), city(), goal(), completedLessons(), totalLessons().
 */
